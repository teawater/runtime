...
func (f *firecracker) fromGrpc(ctx context.Context, hypervisorConfig *HypervisorConfig, storage resourceStorage, j []byte) error {
	return errors.New("firecracker is not supported by VM cache")
}

func (f *firecracker) toGrpc() ([]byte, error) {
